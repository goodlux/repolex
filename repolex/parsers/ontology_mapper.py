...
class OntologyMapper:
    ...
    def map_repository_to_rdf(self, parsed_repo: ParsedRepository, 
    ...
    def _build_stable_function_graph(self, parsed_repo: ParsedRepository,
    ...
    def _build_implementation_graph(self, parsed_repo: ParsedRepository,
    ...
    def _build_file_structure_graph(self, parsed_repo: ParsedRepository,
                                        org: str, repo: str, release: str) -> BuiltGraph:
        """

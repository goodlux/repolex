...
The ultimate configuration management system for Repolex's semantic intelligence!
...
class ConfigManager:
    ...
    @property
    def config(self) -> RepolexConfig:
        """⚙️ Get current configuration (lazy loaded)"""
        if self._config is None:
            self.load_config()
        return self._config
    
    def load_config(self) -> RepolexConfig:
        ...
        try:
            if self.config_path.exists():
                ...
                self._config = RepolexConfig(**config_data)
        ...
        try:
            ...
            for part in parts:
                if hasattr(current, part):
                    ...
                    logger.debug(f"Setting not found: {setting_path}, using default: {default}")
                    return default
    ...
    def import_config(self, import_path: Path) -> bool:
        ...
        try:
            ...
            imported_config = RepolexConfig(**config_data)

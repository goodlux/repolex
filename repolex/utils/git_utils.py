...
from repolex.models.exceptions import GitError, SecurityError, ValidationError, RepolexError
from repolex.utils.validation import validate_org_repo
from repolex.utils.path_utils import resolve_path_safely, ensure_path_within_bounds
...
def temporary_git_clone(url: str, branch: Optional[str] = None):
    ...
    temp_dir = None
    try:
        temp_dir = Path(tempfile.mkdtemp(prefix="Repolex_git_", suffix="_tmp"))

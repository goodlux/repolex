...
from repolex.models.exceptions import RepolexError, SecurityError, ValidationError
from repolex.utils.validation import validate_file_path, validate_export_path


class FileOperationError(RepolexError):
...
@contextmanager
def temporary_directory(prefix: str = "Repolex_", suffix: str = "_tmp"):
    """
...
@contextmanager
def temporary_file(mode: str = 'w+', suffix: str = '', prefix: str = 'Repolex_',

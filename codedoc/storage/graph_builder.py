...
class GraphBuilder:
    ...
    def build_stable_function_graph(self, org: str, repo: str, functions: List[FunctionInfo]) -> BuiltGraph:
        ...
        for func in functions:
            ...
            triples.extend([
                ...
                f'<{stable_uri}> <http://codedoc.org/githubUrl> "https://github.com/{org}/{repo}" .',
            ])
    ...
    def _build_file_structure_graphs(self, context: GraphBuildContext) -> List[BuiltGraph]:
        ...
        for file_info in context.parsed_data.files:
            ...
            triples.extend([
                f"<{file_uri}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://codedoc.org/files/PythonFile> .",
                f'<{file_uri}> <http://codedoc.org/files/path> "{file_info.path}" .',
                f'<{file_uri}> <http://codedoc.org/files/relativePath> "{file_info.relative_path}" .',
                f'<{file_uri}> <http://codedoc.org/files/lineCount> "{file_info.line_count}"^^<http://www.w3.org/2001/XMLSchema#integer> .',
            ])
            ...
            triples.append(
                f'<{file_uri}> <http://codedoc.org/files/githubUrl> "{github_url}" .'
            )
            ...
            for func_name in file_info.contained_functions:
                ...
                triples.append(
                    f"<{file_uri}> <http://codedoc.org/files/containsFunction> <{impl_uri}> ."
                )
    ...
    def _build_abc_events_graph(self, context: GraphBuildContext) -> List[BuiltGraph]:
        ...
        if context.previous_release_data:
            ...
            for event in change_events:
                ...
                triples.extend([
                    f"<{event_uri}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://codedoc.org/abc/Event> .",
                    f'<{event_uri}> <http://codedoc.org/abc/eventType> "{event.event_type}" .',
                    f'<{event_uri}> <http://codedoc.org/abc/timestamp> "{event.timestamp.isoformat()}"^^<http://www.w3.org/2001/XMLSchema#dateTime> .',
                ])
                ...
                if event.affected_function:
                    ...
                    triples.append(
                        f"<{event_uri}> <http://codedoc.org/abc/affects> <{stable_uri}> ."
                    )
        ...
        triples.extend([
            f"<{processing_event_uri}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://codedoc.org/abc/Event> .",
    ...
    def _build_processing_metadata_graphs(self, context: GraphBuildContext) -> List[BuiltGraph]:
        ...
        triples.extend([
            f'<{metadata_uri}> <http://codedoc.org/meta/publicFunctions> "{len(public_functions)}"^^<http://www.w3.org/2001/XMLSchema#integer> .',
            f'<{metadata_uri}> <http://codedoc.org/meta/complexityScore> "{complexity_score}"^^<http://www.w3.org/2001/XMLSchema#integer> .',
        ])
    ...
    def _build_git_ontology_graph(self, context: GraphBuildContext) -> BuiltGraph:
        ...
        triples = [
            "<http://codedoc.org/git/Commit> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#Class> .",
            "<http://codedoc.org/git/Developer> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#Class> .",
            "<http://codedoc.org/git/author> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#ObjectProperty> .",
            "<http://codedoc.org/git/sha> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#DatatypeProperty> .",
        ]
    ...
    def _build_evolution_ontology_graph(self, context: GraphBuildContext) -> BuiltGraph:
        ...
        triples = [
            "<http://codedoc.org/evolution/FunctionChange> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#Class> .",
            "<http://codedoc.org/evolution/AnalysisResult> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#Class> .",
            "<http://codedoc.org/evolution/changeFrequency> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#DatatypeProperty> .",
        ]
    ...
    def _build_files_ontology_graph(self, context: GraphBuildContext) -> BuiltGraph:
        ...
        triples = [
            "<http://codedoc.org/files/PythonFile> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#Class> .",
            "<http://codedoc.org/files/path> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#DatatypeProperty> .",
            "<http://codedoc.org/files/containsFunction> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://www.w3.org/2002/07/owl#ObjectProperty> .",
        ]
    ...
    def _build_branches_graph(self, context: GraphBuildContext) -> BuiltGraph:
        ...
        triples = [
            f'<{graph_uri}#main> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://codedoc.org/git/Branch> .',
            f'<{graph_uri}#main> <http://codedoc.org/git/name> "main" .',
        ]
    ...
    def _build_tags_graph(self, context: GraphBuildContext) -> BuiltGraph:
        ...
        triples = [
            f'<{graph_uri}#{context.release}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://codedoc.org/git/Tag> .',
            f'<{graph_uri}#{context.release}> <http://codedoc.org/git/name> "{context.release}" .',
        ]
    ...
    def _build_analysis_graph(self, context: GraphBuildContext) -> BuiltGraph:
        ...
        triples = [
            f'<{graph_uri}#analysis> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://codedoc.org/evolution/AnalysisResult> .',
            f'<{graph_uri}#analysis> <http://codedoc.org/evolution/version> "{context.release}" .',
        ]
    ...
    def _build_patterns_graph(self, context: GraphBuildContext) -> BuiltGraph:
        ...
        for pattern, count in patterns.items():
            if count > 1:  # Only patterns that appear multiple times
                ...
                triples.extend([
                    f"<{pattern_uri}> <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://codedoc.org/evolution/Pattern> .",
                    f'<{pattern_uri}> <http://codedoc.org/evolution/patternName> "{pattern}" .',
                    f'<{pattern_uri}> <http://codedoc.org/evolution/frequency> "{count}"^^<http://www.w3.org/2001/XMLSchema#integer> .',
                ])

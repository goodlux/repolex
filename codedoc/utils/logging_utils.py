...
from codedoc.utils.path_utils import get_logs_directory, ensure_directory
...
class PAC_MAN_Logger:
    ...
    def __init__(self, name: str = "codedoc", logs_dir: Optional[Path] = None):
        """
    ...
    def _configure_standard_logging(self) -> None:
        ...
        logging.basicConfig(
            ...
            handlers=[
                ...
                logging.FileHandler(self.logs_dir / "codedoc.log"),
            ]
        )

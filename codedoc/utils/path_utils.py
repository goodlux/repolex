...
from codedoc.models.exceptions import ValidationError, SecurityError, CodeDocError
from codedoc.utils.validation import validate_file_path


class PathError(CodeDocError):
    """🟡 PAC-MAN path operation error."""
    pass


def get_codedoc_home() -> Path:
    """
    🟡 Get CodeDoc home directory - PAC-MAN's main base!
    
    Returns ~/.codedoc/ by default, or uses CODEDOC_HOME environment variable.
    
    Returns:
        Path: CodeDoc home directory
    """
    home_env = os.environ.get('CODEDOC_HOME')
    if home_env:
        return Path(home_env).expanduser().resolve()
    else:
        return Path.home() / '.codedoc'
...
def get_repos_directory() -> Path:
    ...
    Returns:
        Path: Repository storage directory (~/.codedoc/repos/)
    """
    return get_codedoc_home() / 'repos'
...
def get_config_directory() -> Path:
    ...
    Returns:
        Path: Configuration directory (~/.codedoc/config/)
    """
    return get_codedoc_home() / 'config'
...
def get_cache_directory() -> Path:
    ...
    Returns:
        Path: Cache directory (~/.codedoc/cache/)
    """
    return get_codedoc_home() / 'cache'
...
def get_logs_directory() -> Path:
    ...
    Returns:
        Path: Logs directory (~/.codedoc/logs/)
    """
    return get_codedoc_home() / 'logs'
...
def get_exports_directory() -> Path:
    ...
    Returns:
        Path: Exports directory (~/.codedoc/exports/)
    """
    return get_codedoc_home() / 'exports'
...
def get_repository_path(org: str, repo: str) -> Path:
    ...
    Returns:
        Path: Repository base path (~/.codedoc/repos/org/repo/)
    """
...
def get_repository_version_path(org: str, repo: str, version: str) -> Path:
    ...
    Returns:
        Path: Repository version path (~/.codedoc/repos/org/repo/version/)
    """
...
def get_oxigraph_database_path() -> Path:
    ...
    Returns:
        Path: Oxigraph database directory (~/.codedoc/oxigraph/)
    """
    return get_codedoc_home() / 'oxigraph'
...
def get_config_file_path() -> Path:
    ...
    Returns:
        Path: Configuration file path (~/.codedoc/config/config.json)
    """
...
def pac_man_home() -> Path:
    ...
    return get_codedoc_home()


def is_pac_man_territory(path: Path) -> bool:
    """🟡 Check if path is in PAC-MAN's territory (CodeDoc directories)!"""
    try:
        pac_home = get_codedoc_home()

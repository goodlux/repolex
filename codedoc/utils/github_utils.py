...
from codedoc.models.exceptions import GitError, SecurityError, ValidationError, NetworkError, CodeDocError
from codedoc.utils.validation import validate_org_repo


class GitHubError(CodeDocError):
...
class GitHubAPIClient:
    ...
    def __init__(self, token: Optional[str] = None, rate_limiter: Optional[GitHubRateLimiter] = None):
        ...
        # Set user agent
        self.session.headers.update({
            'User-Agent': 'CodeDoc-PAC-MAN/1.0 (https://github.com/codedoc/codedoc)'
        })

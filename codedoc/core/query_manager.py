...
class QueryManager:
    ...
    async def execute_sparql(self, query: str, progress_callback: Optional[Callable] = None) -> List[Dict[str, Any]]:
    ...
    async def search_functions(self, search_term: str, progress_callback: Optional[Callable] = None) -> List[Dict[str, Any]]:

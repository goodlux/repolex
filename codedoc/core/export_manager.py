...
The ultimate data export system for CodeDoc's semantic intelligence!
...
class ExportOptions(BaseModel):
    ...
    xml_root_element: str = Field("codedoc", description="XML root element name")
    html_title: str = Field("CodeDoc Export", description="HTML page title")
    markdown_title: str = Field("# CodeDoc Export", description="Markdown title")
...
class ExportManager:
    ...
    def _export_turtle(self, data: Any, options: ExportOptions) -> str:
        ...
        output = []
        output.append("@prefix codedoc: <http://codedoc.example.org/> .")
    ...
    def _export_ntriples(self, data: Any, options: ExportOptions) -> str:
        ...
        for i, item in enumerate(items):
            subject = f"<http://codedoc.example.org/item_{i}>"
    ...
    def _export_rdf_xml(self, data: Any, options: ExportOptions) -> str:
        ...
        root.set("{http://www.w3.org/2000/xmlns/}codedoc", "http://codedoc.example.org/")
        ...
        for i, item in enumerate(items):
            ...
            description.set("{http://www.w3.org/1999/02/22-rdf-syntax-ns#}about", f"http://codedoc.example.org/item_{i}")
    ...
    def _export_jsonld(self, data: Any, options: ExportOptions) -> str:
        ...
        context = {
            "@context": {
                "codedoc": "http://codedoc.example.org/",
                "pac": "http://pacman.example.org/",
                "@base": "http://codedoc.example.org/"
            }
        }
    ...
    def _export_markdown(self, data: Any, options: ExportOptions) -> str:
        ...
        output.append("---")
        output.append("*Generated by PAC-MAN's CodeDoc v2.0 - WAKA WAKA! 🟡*")
    ...
    def _export_html(self, data: Any, options: ExportOptions) -> str:
        ...
        html_parts.append(f"        <p><em>Generated by PAC-MAN's CodeDoc v2.0 on {datetime.now().isoformat()}</em></p>")
        html_parts.append(f"    </div>")

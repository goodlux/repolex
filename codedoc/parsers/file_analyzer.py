...
class FileAnalyzer:
    ...
    async def analyze_repository_files(self, repo_path: Path, org: str, 
    ...
    async def generate_file_graphs_with_github_links(self, parsed_repo: ParsedRepository,
                                                   org: str, repo: str, release: str) -> BuiltGraph:
        """Generate file graphs with GitHub links"""
        
        # Analyze files if not already done
        file_analysis = await self.analyze_repository_files(
